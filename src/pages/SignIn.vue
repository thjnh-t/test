            ...
            <div class="login-wrapper">
                ...
                <div class="login-form">
                    ...
                    <div class="password form-item">
                        <span>Mật khẩu</span>
                        <input type="password" v-model="password" class="input-item" placeholder="Nhập mật khẩu">
                    </div>
    ...
    setup() {
        ...
        const fetchAccounts = async () => {
            try {
                ...
                accounts.value = response.data;  // Lưu dữ liệu tài khoản
            } catch (error) {
        ...
        const login = () => {
            const user = accounts.value.find(acc => acc.username === username.value);
            if (user && user.password === password.value) {
                // Đăng nhập thành công, chuyển hướng đến trang dashboard
                router.push('/dashboard');  // Sử dụng router.push() từ useRouter
            } else {
                // Đăng nhập thất bại
