      ...
      <div v-show="dropdownOpen"
        ...
        <ul ref="dropdown" @focusin="dropdownOpen = true" @focusout="dropdownOpen = false">
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0"
              @click="dropdownOpen = false">
              <span class="block text-sm mb-2">📣 <span class="font-medium text-gray-800 dark:text-gray-100">Chỉnh
                  sửa</span> by Trần Kim Thịnh VueJS - NodeJS - MongoDB</span>
              <span class="block text-xs font-medium text-gray-400 dark:text-gray-500">DEC 12, 2024</span>
            </router-link>
          </li>
