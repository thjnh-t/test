  ...
  <div class="relative inline-flex">
    <button ref="trigger" class="inline-flex justify-center items-center group" aria-haspopup="true"
      ...
      <div class="flex items-center truncate">
        <span
          class="truncate ml-2 text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">thjnh</span>
    ...
    <transition enter-active-class="transition ease-out duration-200 transform"
      ...
      <div v-show="dropdownOpen"
        ...
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
          <div class="font-medium text-gray-800 dark:text-gray-100">thjnh</div>
        ...
        <ul ref="dropdown" @focusin="dropdownOpen = true" @focusout="dropdownOpen = false">
          ...
          <li>
            <router-link
              ...
              to="/" @click="dropdownOpen = false">Sign Out</router-link>
          </li>
        </ul>
      </div>
    </transition>
